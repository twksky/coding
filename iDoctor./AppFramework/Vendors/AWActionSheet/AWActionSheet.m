...
#if ! __has_feature(objc_arc)
        self.scrollView = [self.scrollView autorelease];
#endif
...
#if ! __has_feature(objc_arc)
            self.pageControl = [self.pageControl autorelease];
#endif
...
#if ! __has_feature(objc_arc)
        self.items = [self.items autorelease];
#endif
    }
    return self;
}
...
#if ! __has_feature(objc_arc)
        self.iconView = [self.iconView autorelease];
#endif
...
#if ! __has_feature(objc_arc)
        self.titleLabel = [self.titleLabel autorelease];
#endif
