...
#define MTemplateCollectionViewReuseIdentifier @"7888c09e-5827-41ff-89e2-cf0923f9cad1"

@interface TemplateSettingWithoutCategoriesViewController ()
<
...
@implementation TemplateSettingWithoutCategoriesViewController
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    TemplateCollectionViewCell *templateCollectionViewCell = [collectionView dequeueReusableCellWithReuseIdentifier:MTemplateCollectionViewReuseIdentifier forIndexPath:indexPath];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    EditTemplateViewController *evc = [[EditTemplateViewController alloc] initWithTemplate:model];
    evc.delegate = self;
...
- (UICollectionView *)mTemplatesCollectionView {
    ...
    if (!_mTemplatesCollectionView) {
        ...
        [_mTemplatesCollectionView registerClass:[TemplateCollectionViewCell class] forCellWithReuseIdentifier:MTemplateCollectionViewReuseIdentifier];
