...
@interface MyTemplateCollectionViewAdapter ()

@property (nonatomic, strong) NSString *reuseIdentifier;

@end

@implementation MyTemplateCollectionViewAdapter
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row < [self.templates count]) {
        ...
        if (self.delegate && [self.delegate respondsToSelector:@selector(moreMyTemplate)]) {
            
            [self.delegate moreMyTemplate];
        }
    }
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row < [self.templates count]) {
        ...
        [templateCollectionViewCell setAsMoreTemplateCellStyle];
    }
