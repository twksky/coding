...
@interface TemplateController ()<UITableViewDataSource, UITableViewDelegate>
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    IDAddNewTemplateViewController *add = [[IDAddNewTemplateViewController alloc] initWithTitle:model.name];
