...
class TYWenZhenListViewController: TYBaseViewController,UITableViewDataSource,UITableViewDelegate {
    ...
    private func downLoadData(){
        ...
        let parameter = ["fromDcId":TYDoctorInformationStorage.doctorInformation().userId]
